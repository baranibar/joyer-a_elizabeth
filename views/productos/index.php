...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top pt-5">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand logo h1 align-self-center royal-text text-dark mb-0 mt-0" href="build/views/productos/index.php">
                Elizabeth
                <p class="text-center royal-text mb-0 mt-0">
                    Joyeria
                </p>  
            </a>            
    ...
    <section class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 p-4 mt-3">
                <a href="#"><img src=<?php echo $categoria->url; ?> class="rounded-circle img-fluid border"></a>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src=<?php echo $producto->url; ?> class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <li class="text-muted text-right">S/ <?php echo $producto->precio; ?></li>
                            </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="#">Dijes</a></li>
                    </ul>
                </div>
